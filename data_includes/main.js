...
newTrial("demographics",
    ...
    newDropDown("demo_gender", "").add("", "Male", "Female", "Prefer not to say").log().print(),
    newText("demoEthnicLabel", "Ethnic category:").print(),
    newDropDown("demo_ethnic", "").add("", "Hispanic or Latino", "Not Hispanic or Latino", "Prefer not to say").log().print(),
    newText("demoRaceLabel", "Racial category:").print(),
    newDropDown("demo_race", "").add("", "American Indian / Alaskan Native", "Asian", "Black / African American", "Native Hawaiian / Pacific Islander", "White / Caucasian", "Prefer not to say", "Other").log().print(),
