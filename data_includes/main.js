...
Sequence(
    "intro", "language", "instructionsFullScreen",
    "instructionsDemo", "instructionsReminder", "instructionsReminder2",
...
newTrial("instructionsDemo",
    ...
    newText("instruDemoNote", "In this study, you will see sequences of photographs of various objects. Before each block (sequence), you will be presented with a 'target' image, such as the below image:").css("padding","5px").css("text-align","center").center().print(),
    ...
    newCanvas("demoTargets", 1100, 375)
        ...
        .center().print(),
    newText("instruDemoReminder", "Once the sequence starts, your job is to press the 'f' key if the image you see is the target image, and the 'j' key if not.").css("padding","5px").css("text-align","center").center().print(),
...
newTrial("instructionsReminder2",
    newText("instruReminderTitle", "Instructions").css("font-size","24pt").css("padding","10px").css("text-align","center").center().print(),
    newText("instruReminderNote", "Perform this task both as fast and as accurately as you can! To do so, keep one index finger on the 'f' key, and your other index finger on the 'j' key.").css("padding","5px").css("text-align","center").center().print(),
    newText("instruReminderNote2", "If you respond correctly, the image border will turn green. If you do not, the image border will turn red.").css("padding","5px").css("text-align","center").center().print(),
    newText("instruReminderNote3", "You must act quickly! You will only have 1 second to press the button if you see the target. Otherwise, the trial will be marked as an error.").css("font-weight","bold").css("padding","5px").css("text-align","center").center().print(),
    newButton("reminderNext", "Next").css("padding","5px").css("text-align","center").center().print().wait()
);
...
function makeBlockIntro(trialName, targetImageFile, trialsCompleted) {
    ...
    newTrial(trialName,
        ...
        newText("blockNote", "Here is the target image:").css("padding","5px").css("text-align","center").center().print(),
        newText("blockNote2", "Remember that the image may appear as it does on the left, or mirror-flipped as on the right. You should respond to the target in both cases!").center().print(),
        ...
        newCanvas("blockTargets", 1100, 375)
            ...
            .center().print(),
        newText("blockReminder", "Take your time and memorize the target image well. You will only get to see this image here, at the beginning of the block. Once the sequence begins, you will have to rely on your memory to identify the target image.").css("font-weight","bold").css("padding","10px").css("text-align","center").print(),
        newText("blockKeys", "You should press the 'f' key if the image you see is the target image above, and to press the 'j' key if not.").css("font-weight","bold").css("padding","5px").css("text-align","center").center().print(),
        newText("blockSpeed", "Remember: You must respond quickly! If you don't respond to an image within 1 second, the trial will time out and be considered an error!").css("padding","5px").css("text-align","center").center().print(),
        newText("blockReady", "When ready, press Enter/Spacebar or click 'Begin' to begin the sequence. Get ready!").center().print(),
...
newTrial("comments",
    newText("commentsTitle", "Done! You can now go ahead and submit. Thank you!")
        .css("font-size","24pt").css("padding","10px").css("text-align","center").center().print()
    ,
    newText("commentsNote", "You can also feel free to leave any comments below about how the experiment went!")
        .css("padding","5px").css("text-align","center").center().print()
    ,
    newTextInput("feedbackBox", "")
        .settings.lines(4)
        .css("width", "400px")
        .center()
        .print()
    ,
    newText("commentReminder", "Also, in this experiment, there were several categories of interest (groups of images that were related in a certain way). If you had to guess, what might have been the categories? We're interested to know if you can guess right!")
        .css("padding","5px").css("text-align","center").center().print()
    ,
    newTextInput("categoryBox", "")
        .settings.lines(4)
        .css("width", "400px")
        .center()
        .print()
    ,
    newButton("submitButton", "Submit results")
        .css("padding","5px").css("text-align","center").center().print().wait()
);
