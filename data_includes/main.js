...
newTrial("instructionsReminder",
    ...
    newText("instruReminderNote", "This will be extra tricky because the target image for one sequence will be a non-target image in a different sequence later in the experiment.").css("padding","5px").css("font-weight","bold").css("text-align","center").center().print(),
...
newTrial("instructionsReminder2",
    newText("instruReminderTitle", "Instructions").css("font-size","24pt").css("padding","10px").css("text-align","center").center().print(),
    newText("instruReminderNote", "Perform this task both as fast and as accurately as you can!").css("padding","5px").css("font-weight","bold").css("text-align","center").center().print(),
    newText("instruReminderNote2", "To do so, keep one index finger on the 'f' key, and your other index finger on the 'j' key. If you respond correctly, the image border will turn green. If you do not, the image border will turn red.").css("padding","5px").css("text-align","center").center().print(),
    newText("instruReminderNote3", "You must act quickly! You will only have 1 second to press the button if you see the target. Otherwise, the trial will be marked as an error.").css("padding","5px").css("text-align","center").center().print(),
    newButton("reminderNext", "Next").css("padding","5px").css("text-align","center").center().print().wait()
);
...
function makeBlockIntro(trialName, targetImageFile, trialsCompleted) {
    ...
    newTrial(trialName,
        ...
        newText("blockSpeed", "Remember: You must respond quickly! If you don't respond to an image within 1 second, the trial will time out and be considered an error! When ready, press Enter/Spacebar or click 'Begin' to begin the sequence. Get ready!").css("padding","5px").css("text-align","center").center().print(),
